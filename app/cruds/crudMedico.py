...
def todoMedicos()-> List[MedicoInfo]:
    ...
    try:
        ...
        medicos = []
        query = "SELECT idMedico, p.Nombre, p.Apellido, e.Especialidad FROM Medicos AS m INNER JOIN Personas AS p ON m.idMedico = p.idPersona INNER JOIN Especialidades as e ON m.IdEspecialidad = e.IdEspecialidad"
